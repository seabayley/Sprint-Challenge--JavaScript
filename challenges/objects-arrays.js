...
const unisWithUni = graduates.filter(grad => grad.university.toLowerCase().includes('uni'));
...
*/
const populationTotal = zooAnimals.reduce((a, animal) => a += animal.population, 0);
